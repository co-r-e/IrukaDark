...
- **ウィンドウコントロール機能**: 17種類のキーボードショートカットでウィンドウを正確に配置。
  - **半分**: 左半分、右半分、上半分、下半分
  - **4分割**: 左上、右上、左下、右下
  - **3分割**: 左1/3、中央1/3、右1/3、左2/3、右2/3
  - **その他**: 最大化、中央配置、次のモニター、前のモニターへ移動
- **カスタム指示機能**: IrukaDark AIの応答スタイルをパーソナライズ。
  - 「あなたについて」で個人的なコンテキスト（名前、職業など）を設定
  - IrukaDarkへの具体的な指示を提供可能
  - 設定 → カスタム指示からアクセス

### Changed

- WindowControllerのコードドキュメントと構造を改善。
