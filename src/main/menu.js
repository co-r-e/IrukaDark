          ...
          { type: 'separator' },
          {
            ...
            submenu: [
              ...
              },
              {
                label: t.opacity70,
                type: 'radio',
                checked: Math.abs(windowOpacity - 0.7) < 0.005,
                click: () => ctx.handleWindowOpacityChange(0.7),
              },
              {
                label: t.opacity60,
                type: 'radio',
                checked: Math.abs(windowOpacity - 0.6) < 0.005,
                click: () => ctx.handleWindowOpacityChange(0.6),
              },
              {
                label: t.opacity50,
                type: 'radio',
                checked: Math.abs(windowOpacity - 0.5) < 0.005,
                click: () => ctx.handleWindowOpacityChange(0.5),
              },
              {
                label: t.opacity40,
                type: 'radio',
                checked: Math.abs(windowOpacity - 0.4) < 0.005,
                click: () => ctx.handleWindowOpacityChange(0.4),
              },
              {
                label: t.opacity30,
                type: 'radio',
                checked: Math.abs(windowOpacity - 0.3) < 0.005,
                click: () => ctx.handleWindowOpacityChange(0.3),
              },
              {
                label: t.opacity20,
                type: 'radio',
                checked: Math.abs(windowOpacity - 0.2) < 0.005,
                click: () => ctx.handleWindowOpacityChange(0.2),
              },
              {
                label: t.opacity10,
                type: 'radio',
                checked: Math.abs(windowOpacity - 0.1) < 0.005,
                click: () => ctx.handleWindowOpacityChange(0.1),
              },
            ],
          },
          { type: 'separator' },
