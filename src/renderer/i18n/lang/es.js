(function () {
  ...
  window.__IRUKA_REGISTER_I18N__('es', {
    ...
    launcher: {
      ...
      noResults: 'No se encontraron resultados',
      noFavorites: 'No hay favoritos aún. Marca elementos con estrellas para agregarlos aquí.',
      filterApp: 'App',
      filterFile: 'Archivo',
    ...
    settings: {
      ...
      pressKeyHint: 'Presiona Esc para cancelar',
      popupTitle: 'Presiona el nuevo atajo',
      currentLabel: 'Actual',
      popupInstruction: 'Presiona una combinación de teclas...',
      cancel: 'Cancelar',
      apply: 'Cambiar',
      timeout: 'Tiempo de espera agotado. Intenta de nuevo.',
      resetFailed: 'Error al restablecer atajos. Intenta de nuevo.',
