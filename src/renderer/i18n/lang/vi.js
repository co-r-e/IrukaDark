(function () {
  ...
  window.__IRUKA_REGISTER_I18N__('vi', {
    ...
    selectionRephrase: 'Diễn đạt lại',
    ...
    slashDescriptions: {
      ...
      slideCount: 'Đặt số slide cần tạo',
      slideCount1: 'Tạo 1 slide',
      slideCount2: 'Tạo 2 slide',
      slideCount3: 'Tạo 3 slide',
      slideCount4: 'Tạo 4 slide',
      slideTemplate: 'Quản lý mẫu slide',
      slideTemplateItem: (name) => `Áp dụng mẫu "${name}"`,
    },
    ...
    schedule: {
      noSchedules: 'Chưa có lịch trình',
      addSchedule: 'Thêm lịch trình',
      editSchedule: 'Sửa lịch trình',
      time: 'Thời gian',
      action: 'Hành động',
      repeat: 'Lặp lại',
      actionAlarm: 'Báo thức',
      actionOpenApp: 'Mở ứng dụng',
      actionOpenUrl: 'Mở URL',
      ...
      repeatWeekdays: 'Các ngày trong tuần',
      daySun: 'CN',
      dayMon: 'T2',
      dayTue: 'T3',
      dayWed: 'T4',
      ...
      dayFri: 'T6',
      daySat: 'T7',
      pleaseSelectApp: 'Vui lòng chọn ứng dụng',
