(function () {
  ...
  window.__IRUKA_REGISTER_I18N__('tr', {
    ...
    selectionRephrase: 'Yeniden ifade et',
    ...
    schedule: {
      ...
      repeat: 'Tekrar',
      actionAlarm: 'Alarm',
      actionOpenApp: 'Uygulama Aç',
      actionOpenUrl: 'URL Aç',
      ...
      repeatOnce: 'Bir Kez',
      repeatDaily: 'Günlük',
      repeatWeekdays: 'Haftanın Günleri',
      daySun: 'Pz',
      dayMon: 'Pt',
      dayTue: 'Sa',
      dayWed: 'Ça',
      ...
      dayFri: 'Cu',
      daySat: 'Ct',
      pleaseSelectApp: 'Lütfen bir uygulama seçin',
